...
path = '/mnt/working2/felicie/data2/eTheremin/ALTAI/ALTAI_20240822/ALTAI_20240822_SESSION_00/'
...
create_tt(path)(path+'headstage_0/', session_type)
...
create_data_features_mock(path+'headstage_0/', bin_width, sr)
