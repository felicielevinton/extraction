...
root = '/mnt/working2/felicie/Python_theremin/Analyse/Analyse/Experiment/BURRATA/BURRATA_20240419_SESSION_04/'
...
print('nbr_tons =  ',len(tones_total))
print('trigs =  ',len(an_times))
new_an_times = an_times
