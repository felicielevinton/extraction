...
def read_header(fid):
    ...
    freq['desired_dsp_cutoff_frequency'], freq['desired_lower_bandwidth'], freq['desired_upper_bandwidth']) =\
    ...
    for signal_group in range(1, number_of_signal_groups + 1):
        ...
        (signal_group_enabled, signal_group_num_channels, signal_group_num_amp_channels) =\
        ...
        if (signal_group_num_channels > 0) and (signal_group_enabled > 0):
            for signal_channel in range(0, signal_group_num_channels):
                new_channel = {'port_name': signal_group_name, 'port_prefix': signal_group_prefix,
                               'port_number': signal_group, 'native_channel_name': read_qstring(fid),
                ...
                (new_trigger_channel['voltage_trigger_mode'], new_trigger_channel['voltage_threshold'],
                 new_trigger_channel['digital_trigger_channel'], new_trigger_channel['digital_edge_polarity']) =\
